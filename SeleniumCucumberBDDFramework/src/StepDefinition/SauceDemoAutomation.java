...
//	}
//	@Given("test URL")
//	public void hit_the_compact_identity_urla() throws Exception {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			test = extent.createTest(Feature.class, "www.saucedemo.com Automation");
...
//	public void enter_username1() throws Exception {
//		ExtentTest logInfo = null;
//		saucelogin = new sauceLogin(driver);
//		try {
//
...
//	public void enter_password1() throws Exception {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			Map<String, String> TestDataInMap = ExcelHandler
...
//	
//	
//	@Given("Enter trusty login URL")
//	public void enter_trusty_login_URL() {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			test = extent.createTest(Feature.class, "Trusty Login Automation test");
//			test = test.createNode(Scenario.class, "verify Trusty Login positive schenario");
//			logInfo = test.createNode(new GherkinKeyword("Given"), "Enter trusty login URL");
//			
//			driver = BrowserUtility.OpenBrowser(driver, properties.getProperty("browser"),
//					
//					properties.getProperty("URL"),properties.getProperty("HeadLess"));
...
//	}
//
//	@When("enter trusty username")
//	public void enter_trusty_username() {
//		ExtentTest logInfo = null;
...
//	}
//
//	@When("enter trusty password")
//	public void enter_trusty_password() {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			Map<String, String> TestDataInMap = ExcelHandler
...
//			logInfo = test.createNode(new GherkinKeyword("When"), "enter password");
//
//			new TrustyLogin(driver).enterPassword(password);
//
//			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
//		} catch (AssertionError | Exception e) {
//			testStepHandle("FAIL", driver, logInfo, e);
...
//	}
//	
//	@Given("trusty applicaation should be open")
//	public void trusty_applicaation_should_be_open() {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			test = extent.createTest(Feature.class, "Trusty Login");
//			test = test.createNode(Scenario.class, "Trusty Login demo");
//			logInfo = test.createNode(new GherkinKeyword("Given"), "trusty applicaation should be open");
//			driver = BrowserUtility.OpenBrowser(driver, properties.getProperty("browser"),
//					properties.getProperty("URL"),properties.getProperty("HeadLess"));
//
//			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
...
//	}
//
//	@When("enter TrustyDemo username")
//	public void enter_TrustyDemo_username() {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			Map<String, String> TestDataInMap = ExcelHandler
//					.getTestDataInMap(properties.getProperty("testdatafilepath"), "TrustyDemo", "Data1");
//
//			String email = TestDataInMap.get("email");
//			
//			logInfo = test.createNode(new GherkinKeyword("When"), "enter TrustyDemo username");
//
//			new trustyLoginDemoPage(driver).enterEmail(email);
//
//			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
//		} catch (AssertionError | Exception e) {
//			testStepHandle("FAIL", driver, logInfo, e);
...
//	    	}
//
//	@When("enter TrustyDemo password")
//	public void enter_TrustyDemo_password() {
//		ExtentTest logInfo = null;
//		try {
//			Properties properties = obj.getProperty();
//			Map<String, String> TestDataInMap = ExcelHandler
...
//			String Password = TestDataInMap.get("Password");
//			
//			logInfo = test.createNode(new GherkinKeyword("When"), "enter TrustyDemo password");
//
//			new trustyLoginDemoPage(driver).enterpassword(Password);
//
//			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
//		} catch (AssertionError | Exception e) {
//			testStepHandle("FAIL", driver, logInfo, e);
...
//		ExtentTest logInfo = null;
//		td=new trustyLoginDemoPage(driver);
//		try {
//			
//			
//			logInfo = test.createNode(new GherkinKeyword("When"), "Click on login");
//
//			td.clickOnLogin();
//
//			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
